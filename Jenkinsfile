pipeline {
    ...
    environment {
        DOCKER_IMAGE = "docker.io/alphaly94/fastapi-examen"  // Remplace 
par ton DockerHub
...
'https://github.com/alphaly94/Jenkins_devops_exams.git'
            }
        }
...
'KUBECONFIG_CREDENTIALS_ID']) {
                    ...
                    sh "helm upgrade --install fastapi-app ./fastapi-chart 
